...
| `special_gfx_out/` | Friendly arranged assets needing a custom layout: Sonic + hammock (`SONIC_HAMACA.md`), the ending “Fin.” (`FIN.md`), and Corona's sword swing (`ESPADA.md`). |
