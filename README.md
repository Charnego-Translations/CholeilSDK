...
| `special_gfx_out/` | Friendly arranged assets that need a custom tile map: Sonic + hammock (`SONIC_HAMACA.md`), the ending “Fin.” (`FIN.md`), Corona’s attack poses and separately equipped Sacred Sword (`ESPADA.md`), and the syringe shown only in Soleil Park while other rooms retain the dancing flower (`FLOR_PARQUE.md`). |
